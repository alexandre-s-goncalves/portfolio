...
describe('TextStyled Component', () => {
  ...
  describe('Size prop', () => {
    ...
    test('should have font-size equal to "16px" WHEN the $size prop is "16"', () => {
      const {container} = render(<TextStyled $size={16}>Test</TextStyled>);
  ...
  describe('MarginTop prop', () => {
    ...
    test('should have margin-top equal to "20px" WHEN the $marginTop prop is "20"', () => {
      const {container} = render(<TextStyled $marginTop={20}>Test</TextStyled>);
      expect(container.firstChild).toHaveStyleRule('margin-top', '20px');
    });
  ...
  describe('ToUpper prop', () => {
    ...
    test('should have text-transform equal to "none" WHEN the $toUpper prop is false', () => {
      const {container} = render(<TextStyled $toUpper={false}>Test</TextStyled>);
  ...
  describe('Cursor prop', () => {
    ...
    test('should have cursor equal to "default" WHEN the $cursor prop is "default"', () => {
      const {container} = render(<TextStyled $cursor="default">Test</TextStyled>);
  ...
  describe('LineHeight prop', () => {
    ...
    test('should have line-height equal to "24px" WHEN the $lineHeight prop is "24"', () => {
      const {container} = render(<TextStyled $lineHeight={24}>Test</TextStyled>);
  ...
  describe('FontWeight prop', () => {
    ...
    test('should have font-weight equal to "700" WHEN the $fontWeight prop is "700"', () => {
      const {container} = render(<TextStyled $fontWeight={700}>Test</TextStyled>);
      expect(container.firstChild).toHaveStyleRule('font-weight', '700');
    });

    test('should have default font-weight equal to "normal" WHEN the $fontWeight prop is not provided', () => {
      const {container} = render(<TextStyled>Test</TextStyled>);
