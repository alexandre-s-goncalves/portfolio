...
import iArrowForward from 'assets/icons/iArrow-forward.svg';
...
export const Home = () => {
  ...
  return (
    <div className="animate-fade-in lg: flex h-full w-full flex-1 flex-col pb-0 select-none">
      ...
      <div className="w-full border-t border-slate-100 bg-slate-50/70 py-5 md:py-5 dark:border-slate-900 dark:bg-[#0c111d]">
        <div className="mx-auto grid w-full max-w-4xl grid-cols-3 gap-2 px-3 text-center md:gap-4 md:px-6">
          ...
          <div className="flex flex-col items-center justify-center">
            <span
              data-testid="tech-tags-count"
              className="text-xl font-black tracking-tight text-slate-900 md:text-3xl dark:text-slate-50">
              {profile.techTags.length}+
            </span>
            <span className="mt-0.5 text-[9px] font-medium tracking-wider text-slate-500 uppercase md:text-xs dark:text-slate-400">
              {t('metricsTech')}
            </span>
